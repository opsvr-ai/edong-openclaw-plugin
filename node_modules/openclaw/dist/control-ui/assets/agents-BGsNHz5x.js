import{i as e,n as t}from"./lit-BZwq2xLD.js";import{l as n}from"./format-DeRVtGzv.js";import{C as r,D as i,E as a,O as o,S as s,T as c,_ as l,a as u,b as d,d as f,f as p,g as m,h,k as g,m as _,n as v,p as y,r as b,t as x,u as S,v as C,w,x as T,y as E}from"./index-lRzoiIKt.js";import{r as D}from"./channel-config-extras-UBRJa-vU.js";import{i as O,n as k,r as A,t as j}from"./skills-shared-CPLqvR1x.js";function M(n){let{agent:r,configForm:i,agentFilesList:a,configLoading:o,configSaving:c,configDirty:u,onConfigReload:f,onConfigSave:m,onModelChange:h,onModelFallbacksChange:g,onSelectPanel:_}=n,v=E(i,r.id),y=(a&&a.agentId===r.id?a.workspace:null)||v.entry?.workspace||v.defaults?.workspace||`default`,b=v.entry?.model?T(v.entry?.model):T(v.defaults?.model),x=T(v.defaults?.model),S=s(v.entry?.model),w=s(v.defaults?.model)||(x===`-`?null:l(x)),D=S??w??null,O=d(v.entry?.model)??[],k=Array.isArray(v.entry?.skills)?v.entry?.skills:null,A=k?.length??null,j=!!(n.defaultId&&r.id===n.defaultId),M=!i||o||c,N=e=>{let t=O.filter((t,n)=>n!==e);g(r.id,t)};return e`
    <section class="card">
...
//# sourceMappingURL=agents-BGsNHz5x.js.map