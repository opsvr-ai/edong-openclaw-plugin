import{i as e,n as t}from"./lit-BZwq2xLD.js";import{i as n}from"./index-lRzoiIKt.js";function r(r){let i=(r.status&&typeof r.status==`object`?r.status.securityAudit:null)?.summary??null,a=i?.critical??0,o=i?.warn??0,s=i?.info??0,c=a>0?`danger`:o>0?`warn`:`success`,l=a>0?`${a} critical`:o>0?`${o} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-BhKfg0fz.js.map