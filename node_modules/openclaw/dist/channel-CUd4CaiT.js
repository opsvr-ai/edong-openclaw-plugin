...
import { _ as feishuSetupAdapter, a as feishuSetupWizard, c as createFeishuClient, f as listEnabledFeishuAccounts, g as resolveFeishuCredentials, h as resolveFeishuAccount, i as parseFeishuConversationId, m as resolveDefaultFeishuAccountId, p as listFeishuAccountIds } from "./feishu-B3toYTOi.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-Dlxd4mPr.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-BAWMOvWW.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-W8pawNvQ.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-EWHvJFoY.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-D8vGl9dv.js");
			const account = resolveFeishuAccount({
				cfg: ctx.cfg,
