...
import { t as require_dist_cjs$4 } from "./dist-cjs--fuiP8ZF.js";
import { t as require_dist_cjs$5 } from "./dist-cjs-BxinOgxp.js";
import { n as init_client, t as client_exports } from "./client-Bsi-xQsH.js";
import { n as require_dist_cjs$6, t as require_dist_cjs$7 } from "./dist-cjs-BSplkLGd.js";
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await import("./signin-BuGr4fXH.js");
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				...
				const { fromContainerMetadata } = await import("./dist-cjs-BBaVs8UD.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await import("./dist-cjs-BBaVs8UD.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await import("./dist-cjs-i2dU7Gh8.js").then((m) => /* @__PURE__ */ __toESM(m.default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await import("./sts-loZfL2U4.js");
	...
	const resolveProcessCredentials = async (options, profile) => import("./dist-cjs-DXajxhuV.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => import("./dist-cjs-BbjiTcdM.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromTokenFile }) => fromTokenFile({
