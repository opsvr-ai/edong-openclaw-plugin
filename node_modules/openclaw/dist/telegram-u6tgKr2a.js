...
import { C as monitorTelegramProvider, Ch as parseTelegramTarget, Dh as buildTelegramGroupPeerId, E as buildTelegramExecApprovalButtons, Eh as listTelegramDirectoryPeersFromConfig, Lh as resolveTelegramAccount, Ph as listTelegramAccountIds, Rv as createAllowlistProviderRouteAllowlistWarningCollector, S as probeTelegram, Sg as resolveExecApprovalCommandDisplay, Sh as resolveTelegramExecApprovalTarget, Th as listTelegramDirectoryGroupsFromConfig, U_ as createChatChannelPlugin, W_ as defineChannelPluginEntry, _h as resolveTelegramGroupRequireMention, ch as parseTelegramThreadId, em as collectTelegramStatusIssues, lh as looksLikeTelegramTargetId, lm as sendTelegramPayloadMessages, nl as parseTelegramTopicConversation, sh as parseTelegramReplyToMessageId, uh as normalizeTelegramMessagingTarget, vg as buildExecApprovalPendingReplyPayload, vh as resolveTelegramGroupToolPolicy, xh as isTelegramExecApprovalClientEnabled, xm as sendTypingTelegram } from "./pi-embedded-CswW9luA.js";
...
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-CHe49kuw.js";
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-CPVQjGcb.js");
