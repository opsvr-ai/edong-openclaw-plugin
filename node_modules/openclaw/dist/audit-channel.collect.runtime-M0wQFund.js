...
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-B8C32NVU.js";
...
const loadAuditChannelDiscordRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.discord.runtime-B-H3E2M6.js"), ({ auditChannelDiscordRuntime }) => auditChannelDiscordRuntime);
const loadAuditChannelAllowFromRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.allow-from.runtime-Tbe3AM5L.js"), ({ auditChannelAllowFromRuntime }) => auditChannelAllowFromRuntime);
const loadAuditChannelTelegramRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.telegram.runtime-B5Qaqda1.js"), ({ auditChannelTelegramRuntime }) => auditChannelTelegramRuntime);
const loadAuditChannelZalouserRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.zalouser.runtime-BiDlwd1I.js"), ({ auditChannelZalouserRuntime }) => auditChannelZalouserRuntime);
