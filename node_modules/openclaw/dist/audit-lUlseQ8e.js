...
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-sPyjSxSY.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CkQwAoLm.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CpMwWuBe.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BWdoLZ1k.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-D8-toAhD.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-M0wQFund.js");
