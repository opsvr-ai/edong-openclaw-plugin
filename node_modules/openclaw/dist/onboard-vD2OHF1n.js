...
import { t as runSetupWizard } from "./setup-IlQjJXq3.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-DZq_mGJk.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-DMO_bYkB.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-D2G7SaQx.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Bt25CRLg.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-jxv6rzVC.js");
