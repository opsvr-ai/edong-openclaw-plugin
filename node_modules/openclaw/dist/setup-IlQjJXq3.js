...
import { n as buildPluginCompatibilityNotices, o as formatPluginCompatibilityNotice } from "./status-Cty5VFAi.js";
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BlHgzrIM.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-Ba3ksZ4B.js");
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-BB0kHR4L.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-DJFmXoQi.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BUnst8Le.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-B_zj5Xp2.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-dD98_UgV.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-RVLv2dG6.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-BcYSB3rH.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-C8bJNSvf.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-Bq0KzxM-.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-B1Lq2LFO.js");
