...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-CLtbIyEz.js";
...
import { $g as resolveEnvelopeFormatOptions, $r as UserSelectMenu, B_ as summarizeMapping, Br as GuildDeleteListener, Cr as formatDiscordReactionEmoji, Dn as formatMention, F_ as addAllowlistUserEntriesFromConfigEntry, Fg as resolveNativeCommandSessionTargets, Fr as Separator, Gr as PresenceUpdateListener, Hr as MessageCreateListener, I_ as buildAllowlistResolutionSummary, Ir as TextDisplay, Jr as VoiceServerUpdateListener, Kr as ReadyListener, L_ as canonicalizeAllowlistWithResolvedIds, Lr as Container, Pr as chunkDiscordTextWithMode, Qr as RateLimitError, Rr as Row, Sa as buildModelsProviderData, Sg as resolveExecApprovalCommandDisplay, Sr as shouldEmitDiscordReactionNotification, Up as matchPluginCommand, Ur as MessageReactionAddListener, Vp as executePluginCommand, Vr as InteractionCreateListener, Wr as MessageReactionRemoveListener, Xr as ListenerEvent, Yp as getPluginCommandSpecs, Yr as VoiceStateUpdateListener, Zg as formatInboundEnvelope, Zr as Client, _i as Routes, _n as parseDiscordModalCustomIdForCarbon, _r as resolveDiscordMemberAccessState, ai as ChannelSelectMenu, bg as getExecApprovalApproverDmNoticeText, bi as setPresence, bn as resolveDiscordComponentEntry, ci as serializePayload, cn as editDiscordComponentMessage, di as GatewayIntentBits, dr as isDiscordGroupAllowedByPolicy, eb as resolveDiscordAccount, ei as StringSelectMenu, fi as GatewayOpcodes$1, fn as createDiscordFormModal, fr as normalizeDiscordAllowList, gc as dispatchReplyWithDispatcher, gi as ChannelType$1, gn as parseDiscordModalCustomId, gr as resolveDiscordGuildEntry, hc as dispatchReplyWithBufferedBlockDispatcher, hi as ButtonStyle, hn as parseDiscordComponentCustomIdForCarbon, hr as resolveDiscordChannelConfigWithFallback, ii as Command, jr as createDiscordClient, li as ChannelType, mc as createReplyReferencePlanner, mi as ApplicationCommandOptionType, mn as parseDiscordComponentCustomId, mr as resolveDiscordAllowListMatch, nb as resolveDiscordMaxLinesPerMessage, ni as MentionableSelectMenu, nn as unregisterGateway, oi as Button, or as stripUndefinedFields, pn as formatDiscordComponentEventText, pr as normalizeDiscordSlug, qr as ThreadUpdateListener, rb as normalizeDiscordToken, ri as CommandWithSubcommands, si as Plugin, ti as RoleSelectMenu, tn as registerGateway, ug as wrapFetchWithAbortSignal, ui as GatewayCloseCodes$1, vr as resolveDiscordOwnerAccess, wr as formatDiscordUserTag, wt as dispatchPluginInteractiveHandler, xn as resolveDiscordModalEntry, xr as resolveGroupDmAllow, z_ as patchAllowlistUsersInConfigEntries, zr as Modal } from "./pi-embedded-CswW9luA.js";
...
import { o as resolveStoredModelOverride } from "./level-overrides-Ds8ppNbt.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-glrAPRQW.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-Dplfxreg.js");
