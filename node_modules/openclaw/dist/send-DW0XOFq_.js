...
import { Ht as listConfiguredAccountIds } from "./pi-embedded-CswW9luA.js";
...
import { t as require_src } from "./src-Bc4Fm2Ge.js";
import { n as normalizePollInput } from "./polls-GziVvR8X.js";
import { C as resolveMatrixDefaultOrOnlyAccountId, T as resolveMatrixAccountStringValues, b as requiresExplicitMatrixDefaultAccount, h as resolveMatrixAccountStorageRoot, v as resolveMatrixLegacyFlatStoragePaths, w as getMatrixScopedEnvVarNames, x as resolveConfiguredMatrixAccountIds } from "./matrix-De2qOSaQ.js";
import { r as maybeCreateMatrixMigrationSnapshot } from "./matrix-migration-snapshot-DwMbAbfx.js";
import { a as getMatrixRuntime, n as loadMatrixCredentials, t as credentialsMatchConfig } from "./credentials-read-DEweVAqt.js";
import { $ as MapWithDefault, A as VerifierEvent, E as decodeRecoveryKey, N as Preset, O as VerificationPhase, U as KnownMembership, V as UNREAD_THREAD_NOTIFICATIONS, W as EventType$1, Y as logger, Z as MemoryCryptoStore, a as RoomStateEvent, ct as require_asyncToGenerator, et as deepCopy, it as recursiveMapToObject, j as MatrixScheduler, k as VerificationRequestEvent, l as ClientEvent, nt as isSupportedReceiptType, o as MAX_STICKY_DURATION_MS, ot as UnstableValue, q as TypedEventEmitter, s as MatrixEventEvent, st as require_defineProperty, t as VerificationMethod, u as MatrixClient$1, w as CryptoEvent } from "./types-qv9PO0As.js";
import { t as fromBuffer } from "./lib-CivaO6A0.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-z8gsdRcu.js";
import { S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-DdufxOvC.js";
import { l as toRatio, n as decodeString } from "./Util-D0lOgbOQ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BUGW5N7B.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-BdzXA7W9.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DeEen6tC.js";
...
async function loadMatrixCryptoNodeRuntime() {
	matrixCryptoNodeRuntimePromise ??= import("./crypto-node.runtime-D4wiUncc.js");
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-CNStp22K.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BDmu1xc0.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Dqc4h3Ed.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-m_oOVsIF.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-SBBFTM-L.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DoWRO2F3.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CXOkqfuu.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DqmzUVj_.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Bp6PCoCc.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B-A3deHb.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-fNsEWga5.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CWCecO5a.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B3au_-nK.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CAWlBFdF.js")).WaveParser;
	}
};
//#endregion
