...
import { T as resolveAuthProfileDisplayLabel, d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown, n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./auth-profiles-CLtbIyEz.js";
...
import { B as resolveAwsSdkEnvVarName, Eu as describeFailoverError, F as getCustomProviderApiKey, H as resolveUsableCustomProviderApiKey, Ip as resolveModelWithRegistry, L as hasUsableCustomProviderApiKey, Lp as shouldSuppressBuiltInModel, Vy as loadModelCatalog, ft as resolvePluginProviders, go as loadProviderUsageSummary, t as runEmbeddedPiAgent, xu as resolveCommandSecretRefsViaGateway, yo as formatUsageWindowSummary, z as resolveApiKeyForProvider } from "./pi-embedded-CswW9luA.js";
...
import { t as maskApiKey } from "./mask-api-key-C4DAjHlp.js";
...
import { n as redactSecrets } from "./format-T4sBchR_.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Ce54tvSO.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-JT-z_39f.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-DaSGySRC.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BxlHN4Nf.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DMKBJ7dI.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-f7pDs1ju.js");
