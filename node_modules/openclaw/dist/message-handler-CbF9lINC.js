...
import { $g as resolveEnvelopeFormatOptions, An as editMessageDiscord, Bg as resolveMentionGatingWithBypass, Cn as sendPollDiscord, En as sendWebhookMessageDiscord, Er as resolveTimestampMs, Gt as fetchPluralKitMessageInfo, Hg as shouldDebounceTextInbound, Jt as normalizeDiscordOutboundTarget, Og as recordChannelActivity, Pr as chunkDiscordTextWithMode, Ry as EmbeddedBlockChunker, Sn as sendMessageDiscord, Tr as resolveDiscordSystemLocation, Ug as hasControlCommand, Vg as createChannelInboundDebouncer, Zg as formatInboundEnvelope, _i as Routes, _r as resolveDiscordMemberAccessState, br as resolveDiscordShouldRequireMention, d_ as createReplyDispatcherWithTyping, dr as isDiscordGroupAllowedByPolicy, gr as resolveDiscordGuildEntry, hr as resolveDiscordChannelConfigWithFallback, in as reactMessageDiscord, li as ChannelType, nb as resolveDiscordMaxLinesPerMessage, o_ as dispatchInboundMessage, on as removeReactionDiscord, pi as MessageType, pr as normalizeDiscordSlug, un as sendDiscordComponentMessage, vr as resolveDiscordOwnerAccess, wr as formatDiscordUserTag, xr as resolveGroupDmAllow, yn as buildDiscordInteractiveComponents } from "./pi-embedded-CswW9luA.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-CRt0UCps.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
