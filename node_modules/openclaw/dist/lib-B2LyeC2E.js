...
import { t as require_content_type } from "./content-type-Dxffpar4.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Dls_a8Ic.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DANu2Ykj.js";
import { l as toRatio, n as decodeString } from "./Util-CWgLX26F.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-TUwm0GBb.js";
import { t as APEv2Parser } from "./APEv2Parser-CatXObGK.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D1F8TEp-.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CYqt2oF5.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Bi2LlnXZ.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Cqd7aUN-.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BQelcTBt.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-ZB1HA6wk.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-C__WV-V-.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DNsifDK9.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-ChU1BAV5.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-C9AT7NT0.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DslG5KQA.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-6cW_VupR.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-NLRRLcMp.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-D6mRbxg8.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Uy_-RNS9.js")).WaveParser;
	}
};
//#endregion
