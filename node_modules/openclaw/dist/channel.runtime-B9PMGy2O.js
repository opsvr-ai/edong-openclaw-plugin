...
var require_dist_cjs$17 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const remoteProvider = async (init) => {
		const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await import("./dist-cjs-BuIuPj9H.js").then((m) => /* @__PURE__ */ __toESM(m.default));
		if (process.env[ENV_CMDS_RELATIVE_URI] || process.env[ENV_CMDS_FULL_URI]) {
			init.logger?.debug("@aws-sdk/credential-provider-node - remoteProvider::fromHttp/fromContainerMetadata");
			const { fromHttp } = await import("./dist-cjs-sxrDziMw.js").then((m) => /* @__PURE__ */ __toESM(m.default));
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromSSO } = await import("./dist-cjs-CVQdDKJD.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromSSO(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromIni");
			const { fromIni } = await import("./dist-cjs-Koxaq4qU.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromIni(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
			const { fromProcess } = await import("./dist-cjs-DXajxhuV.js").then((m) => /* @__PURE__ */ __toESM(m.default));
			return fromProcess(init)(awsIdentityProperties);
		},
		async (awsIdentityProperties) => {
			init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
			const { fromTokenFile } = await import("./dist-cjs-BbjiTcdM.js").then((m) => /* @__PURE__ */ __toESM(m.default));
